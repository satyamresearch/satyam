...
function BoundaryDrawer(_color, existing_car_axis_points, existing_x_axis_points, existing_y_axis_points, existing_z_axis_points, displayWidth, displayHeight, png)
{
    var canvas = $("#canvas");
    var color = _color;
    ...
    this.drawAllExistingBoundariesFaded = function()
    {
        ...
        if (existing_x_axis_points.length > 0) {
        ...
        if (existing_y_axis_points.length > 0) {
        ...
        if (existing_z_axis_points.length > 0) {
    ...
    this.draw = function()
    {
        ...
        for (var i = 1; i < currentPolygonCardinalPoints.length; i++) {
            ...
            me.drawLine(currentPolygonCardinalPoints[0], currentPolygonCardinalPoints[i], color);
        }
