...
function VideoPlayer(handle, job)
{
    ...
    this.updateframe = function()
    {
        ...
        var url = this.job.frameURLList[this.frame];
        this.handle.css("background-image", "url('" + url + "')");
        var str = job.width + "px";
        this.handle.css("background-size", str);
        this.handle.css("background-size", "no-repeat");
//        this.handle.css("background-position", "no-repeat");
