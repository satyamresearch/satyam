...
function ui_setup(job)
{
    ...
    $("<table>" +
        "<tr>" +
            ...
            "<td><div id='skipbar'></div><div id='submitbar'></div><div id='submitanddonebar'></div><div id='exitbar'></div><div id='instructionsbutton' class='button'>Instructions</div><div id='instructions'></td>" +
...
function ui_submit(job, tracks)
{
    ...
    if (!window.confirm("Are you sure you are ready to submit? Please " +
        ...
        var submit_time = getDateTime();
        $("#JobSubmitTime_Hidden").val(submit_time);
