function TrackObjectUI(button, container, videoframe, job, player, tracks)
{
    ...
    this.setup = function()
    {
        ...
        var html = "<p>Track all the different kinds of objects listed below.<br />";
        html += "-To see examples of objects, click Instructions.<br />";
        html += "-Track only inside the red boundaries.</p>";
