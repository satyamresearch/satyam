...
{
    public partial class ObjectCountingInImage : System.Web.UI.Page
    {
        ...
        private bool getNewRandomJob()
        {
            ...
            SatyamTaskTableEntry entry = taskTableDB.getMinimumTriedEntryByTemplate(TaskConstants.Counting_Image);
            if (entry != null)
            {
