...
{
    public partial class SingleObjectLabeling1 : System.Web.UI.Page
    {
        ...
        private bool getNewRandomJob()
        {
            ...
            SatyamTaskTableEntry entry = taskTableDB.getMinimumTriedEntryByTemplate(TaskConstants.Classification_Image);
            if (entry != null)
            {
