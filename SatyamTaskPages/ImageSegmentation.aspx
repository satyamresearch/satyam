<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImageSegmentation.aspx.cs" Inherits="SatyamTaskPages.ImageSegementation" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <h3> Task:</h3>
        <div><ul>
        <li><strong>Your job</strong> is to draw one/multiple tightly fitting polygons along the boundaries (inner/outer) of <strong style="color:red">each and every instance</strong>(if any) of the objects in the category list.</li>
        ...
        <table>            
            ...
            <tr>
                ...
                <ul>
                    <li id="SecondPoly"><strong>Click on</strong> &quot;Draw A New Boundary&quot; to add a new polygon boundary of the object. This could be a holes inside an existing boundary, or another part of the object that is <strong>not overlapping</strong> with <strong>any</strong> of the existing polygons drawn. If the new part you want to draw is connected/overlapped with an existing part, you should consider delete the existing one and redrawn them together as one whole polygon. </li>
                ...
                <ul>
                    ...
                    <li><strong>When you are done</strong>, check to see if every visible part of the target object is bounded (highlighted by category color). <strong>Click on</strong> &quot;Finish Object&quot; to finish the current object.</li>
