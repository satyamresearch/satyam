<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MultiObjectLocalizationAndLabelingMTurk.aspx.cs" Inherits="SatyamTaskPages.MultiObjectLocalizationAndLabelingMTurk" %>
                    ...
                    <tr><td>
                        <h3>Instructions</h3>                     
                         <ul  id="InstructionsBulletedList">
                             ...
                             <li>You might be presented multiple images in each hit if the task is simple.</li>
                             <li> <strong style="color:red">You will be paid only if you draw tightly fitting boxes around all objects of interest in all the images.</strong></li>
