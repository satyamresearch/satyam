<%@ Page Title="" Language="C#" MasterPageFile="~/JobTemplate.master" AutoEventWireup="true" CodeBehind="Template_SingleObjectLabelingInVideo.aspx.cs" Inherits="SatyamPortal.Template_SingleObjectLabelingInVideo" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id ="Template_SingleObjectLabelingInVideo">        
                    <table>
                        <tr>
                            <td>
                            ...
                            <td class="auto-style1" style="width: 263px">
                                <asp:Panel id="TemplateInfo" runat="server" Visible="True">
                                 <a href="TemplateInfo_SingleObjectLabelingInVideo.aspx">Learn About this Template</a>
                                </asp:Panel>
                                <asp:Panel id="TemplateInfoMturk" runat="server" Visible="False">
                                 <a href="TemplateInfo_SingleObjectLabelingInVideoMTurk.aspx">Learn About this Template</a>
                                </asp:Panel>
                             </td>
...
&nbsp;
        ...
        <div id="ErrorField"> 
            <asp:Label ID="Template_ErrorMessageLabel" runat="server" Text=""></asp:Label>
                   ...
                   <h3>Image Location Information</h3> (Note : All the videos in this location will be launched for labeling automatically. The results file will be stored in the same location. Only MP4 is supported as of now. Also make sure the videos are not too large and do not a long time to load.)
                   <table>
                   <tr><td>
                   <table>
                       <tr>
                      ...
                      <table>
                          <tr>
                              <td style="vertical-align:top">
                                  <table>
                                      <tr><td>
                                          <asp:TextBox ID="AddCategoryTextBox" runat="server" Width="197px" OnTextChanged="Template_SingleObjectLabeling_AddCategoryTextBox_TextChanged"></asp:TextBox>
                                      </td></tr>
                                      <tr><td>
                                          <asp:Button ID="AddNewCategoryButton" runat="server" Text="Add New Category" Width="207px" OnClick="Template_SingleObjectLabeling_AddNewCategoryButton_Click" />
                                      </td></tr>                                      
                                      <tr><td>
                  ...
                  <asp:Panel id="PricePanel" runat="server" Visible="False">   
                      ...
                      <tr>
                          <td>   
                              <strong>Price per Video</strong>(cents/video): 
                         </td>
                          <td>
                          ...
                          <td>
                               (recommended price is 0.2 cents/video. Jobs will be launched in sets of 10 videos. Actual cost will be 3 times this on average since the same image is given to at least 3 people.)
                          </td>
                      </table>
                      <table>
                      <tr>
                          ...
                          <td>
                              ...
                              <asp:TextBox ID="AmazonTaskTitleTextBox" runat="server" Width="336px">Video Classification Task</asp:TextBox>

                          </td>
                          <td>
                              (A short title for your task, 2-3 words long, the turkers might search for this title if they like the job. Default is <strong>Video Classification Task</strong>)
                          </td>
                      </tr>
                      <tr>
                          <td class="auto-style1" style="width: 203px">
                          ...
                          <td>
                              <asp:TextBox ID="AmazonTaskDescriptionTextBox" runat="server" Width="336px">Quickly earn money by simply selecting what a video looks like!</asp:TextBox>
                          </td>
                          <td>
                      ...
                      <tr>
                          ...
                          <td>
                              <asp:TextBox ID="AmazonTaskKeywordsTextBox" runat="server" Width="336px">Short Video Clips, Classify, Categorize</asp:TextBox>
                          </td>
                          <td>
