<%@ Page Title="" Language="C#" MasterPageFile="~/JobTemplate.master" AutoEventWireup="true" CodeBehind="Template_ImageSegmentation.aspx.cs" Inherits="SatyamPortal.Template_ImageSegmentation" %>
                        ...
                        <tr>
                            ...
                            <td class="auto-style1" style="width: 263px">
                                <asp:Panel id="TemplateInfo" runat="server" Visible="True">
                                 <a href="TemplateInfo_ImageSegmentation.aspx">Learn About this Template</a>
                                </asp:Panel>
                  ...
                  <asp:Panel id="PricePanel" runat="server" Visible="False">  
                      ...
                      <tr>
                          ...
                          <td>
                              ...
                              <asp:TextBox ID="AmazonTaskTitleTextBox" runat="server" Width="336px">Object Segmentation in Image</asp:TextBox>
                      ...
                      <tr>
                          ...
                          <td>
                              <asp:TextBox ID="AmazonTaskDescriptionTextBox" runat="server" Width="336px">Fun and quickly way to earn money by drawing polygons to segment objects of interest in an image</asp:TextBox>
                          </td>
                          <td>
                      ...
                      <tr>
                          ...
                          <td>
                              <asp:TextBox ID="AmazonTaskKeywordsTextBox" runat="server" Width="336px">Draw ploygons, segmentation, images</asp:TextBox>
                          </td>
                          <td>
