...
{
    public partial class Template_SingleObjectLabeling : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ddlist1.Items.FindByText("Single Object Labeling In Image").Selected = true;
        ...
        protected void Single_Object_Labeling_JobSubmitButton_Click(object sender, EventArgs e)
        {
            ...
            if (Hidden_MechanicalTurk.Value == "true")
            {
                ...
                price = pricePerImage * TaskConstants.SINGLE_OBJECT_LABLING_MTURK_MAX_IMAGES_PER_TASK;
            ...
            if (Hidden_MechanicalTurk.Value == "true")
            {
                job.JobTemplateType = TaskConstants.Classification_Image_MTurk;
                job.TasksPerJob = TaskConstants.SINGLE_OBJECT_LABLING_MTURK_MAX_IMAGES_PER_TASK;
            }
            else
            {
                job.JobTemplateType = TaskConstants.Classification_Image;
