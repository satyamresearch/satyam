...
{
    public partial class TemplateInfo_MultipleObjectLocalizationAndLabelingMTurk : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ddlist1.Items.FindByText("Multi-Object Localization and Labeling").Selected = true;
