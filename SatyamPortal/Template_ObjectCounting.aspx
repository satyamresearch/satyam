<%@ Page Title="" Language="C#" MasterPageFile="~/JobTemplate.master" AutoEventWireup="true" CodeBehind="Template_ObjectCounting.aspx.cs" Inherits="SatyamPortal.Template_ObjectCounting" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id ="Template_SingleObjectCounting">        
                    <table>
                        <tr>
                            <td>
                                 <h3>Template : Object Counting in an Image</h3> 
                             </td>
                            <td class="auto-style1" style="width: 263px">
                                <asp:Panel id="TemplateInfo" runat="server" Visible="True">
                                 <a href="TemplateInfo_ObjectCountingInImage.aspx">Learn About this Template</a>
                                </asp:Panel>
                                <asp:Panel id="TemplateInfoMturk" runat="server" Visible="False">
                                 <a href="TemplateInfo_ObjectCountingInImageMTurk.aspx">Learn About this Template</a>
                                </asp:Panel>
                             </td>
...
<%--                                 <asp:Button ID="JobSubmitButton" runat="server" Text="Submit Job" onClientClick="return Template_SingleObjectLabeling_SubmitCheck();"/>                            --%>
                                <asp:Button ID="JobSubmitButton" runat="server" Text="Submit Job" OnClick="Object_Counting_JobSubmitButton_Click"/>                            
                            </td>
                        </tr>
                    </table>
...
&nbsp;
        ...
        <div id="ErrorField"> 
            <asp:Label ID="Template_ErrorMessageLabel" runat="server" Text=""></asp:Label>
                   ...
                   <h3>Image Location Information</h3> (Note : All the images/videos in this location will be launched for labeling automatically. The results file will be stored in the same location.)
                   <table>
                   <tr><td>
                   <table>
                       <tr>
                  ...
                  <h3>Object to be Counted
                      <asp:TextBox ID="ObjectNameTextBox" runat="server" Width="317px"></asp:TextBox>
                    </h3>
                   <table>
                       <tr><td>
                           <strong>Description Content</strong> (You can write text to explain about the object to be counted and even add html5 code if you feel compelled e.g. to provide example images etc.)
                        </td></tr>
                        <tr><td>                                            
                  ...
                  <asp:Panel id="PricePanel" runat="server" Visible="False">   
                      ...
                      <table>
                        <tr>
                            <td>
                                <h3>Using Adaptive Pricing?</h3>
                            </td>
                            <td>

                                <asp:CheckBox ID="AdaptivePricingCheckBox" runat="server" onClientClick="return onAdaptivePricingCheckBoxChanged();" AutoPostBack="True" OnCheckedChanged="AdaptivePricingCheckBox_CheckedChanged"/>

                            </td>
                        </tr>
                    </table>
                      <asp:Panel id="AdaptivePricePanel" runat="server" Visible="False"> 
                          <table>
                      <tr>
                          <td>   
                              <strong>Target Price Per Hour</strong>(USD): 
                         </td>
                          <td>

                              <asp:TextBox id="TargetPricePerHourTextBox" runat="server">13.56</asp:TextBox>

                          </td>
                          </tr>
                              <tr>
                          <td>   
                              <strong>Total Budget</strong>(USD): 
                         </td>
                          <td>

                              <asp:TextBox id="BudgetTextBox" runat="server"></asp:TextBox>
                      ...
                      <asp:Panel id="FixedPricePanel" runat="server" Visible="True"> 
                      <table>
                      <tr>
                          <td>   
                          ...
                          <td>
                              ...
                              <asp:TextBox id="PriceTextBox" runat="server">0.1</asp:TextBox>
                      ...
                      <tr>
                          ...
                          <td>
                              ...
                              <asp:TextBox ID="AmazonTaskTitleTextBox" runat="server" Width="336px">Counting Objects in an Image</asp:TextBox>
                      ...
                      <tr>
                          ...
                          <td>
                              <asp:TextBox ID="AmazonTaskDescriptionTextBox" runat="server" Width="336px">Earn money quickly by simply counting the number of objects of interest in an image!</asp:TextBox>
                          </td>
                          <td>
                      ...
                      <tr>
                          ...
                          <td>
                              <asp:TextBox ID="AmazonTaskKeywordsTextBox" runat="server" Width="336px">Count Objects</asp:TextBox>
                          </td>
                          <td>
     ...
     <div>
         ...
         <asp:HiddenField ID="Hidden_AdaptivePricing" runat="server" value="false"/>   
    </div>
</asp:Content>
