<%@ Page Title="" Language="C#" MasterPageFile="~/JobTemplate.master" AutoEventWireup="true" CodeBehind="Template_SingleObjectLabeling.aspx.cs" Inherits="SatyamPortal.Template_SingleObjectLabeling" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id ="Template_SingleObjectLabeling">        
                    <table>
                        <tr>
                            <td>
                            ...
                            <td class="auto-style1" style="width: 263px">
                                <asp:Panel id="TemplateInfo" runat="server" Visible="True">
                                 <a href="TemplateInfo_SingleObjectLabeling.aspx">Learn About this Template</a>
                                </asp:Panel>
                                <asp:Panel id="TemplateInfoMturk" runat="server" Visible="False">
                                 <a href="TemplateInfo_SingleObjectLabelingMTurk.aspx">Learn About this Template</a>
                                </asp:Panel>
                             </td>
...
<%--                                 <asp:Button ID="JobSubmitButton" runat="server" Text="Submit Job" onClientClick="return Template_SingleObjectLabeling_SubmitCheck();"/>                            --%>
                                <asp:Button ID="JobSubmitButton" runat="server" Text="Submit Job" OnClick="Single_Object_Labeling_JobSubmitButton_Click"/>                            
                            </td>
                        </tr>
                    </table>
                  ...
                  <asp:Panel id="PricePanel" runat="server" Visible="False">   
                      ...
                      <tr>
                          ...
                          <td>
                              ...
                              <asp:TextBox ID="AmazonTaskTitleTextBox" runat="server" Width="336px">Image Classification Task</asp:TextBox>
                      ...
                      <tr>
                          ...
                          <td>
                              <asp:TextBox ID="AmazonTaskDescriptionTextBox" runat="server" Width="336px">Quickly earn money by simply selecting what an image looks like!</asp:TextBox>
                          </td>
                          <td>
                      ...
                      <tr>
                          ...
                          <td>
                              <asp:TextBox ID="AmazonTaskKeywordsTextBox" runat="server" Width="336px">Pictures, Classify, Categorize</asp:TextBox>
                          </td>
                          <td>
