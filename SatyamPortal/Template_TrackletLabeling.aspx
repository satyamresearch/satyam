<%@ Page Title="" Language="C#" MasterPageFile="~/JobTemplate.master" AutoEventWireup="true" CodeBehind="Template_TrackletLabeling.aspx.cs" Inherits="SatyamPortal.Template_TrackletLabeling" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table>
        <tr>
            <td>
                <h3>Template : Tracklet Labeling</h3> 
            </td>
            <td class="auto-style1" style="width: 263px">
                <a href="TemplateInfo_TrackletLabeling.aspx">Learn About this Template</a>
            </td> 
                   ...
                   <tr>
                      <td>
                       <table align="center">
                        ...
                        <td class="auto-style3">
                            <table>
                                ...
                                <tr>
                                    <td class="auto-style4">
                                        <asp:ListBox ID="CategoryListBox" runat="server" Width="151px" AutoPostBack="True" OnSelectedIndexChanged="CategoryListBox_SelectedIndexChanged"></asp:ListBox>
                                    </td>
                                </tr>
                            </table>
                        </td>
                       ...
                       <table align="center">
                        <tr>
                            <td class="auto-style2">
                                <asp:TextBox ID="AddSubCategoryTextBox" runat="server" Height="29px" Width="145px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                           <td>
                            <asp:Button ID="AddSubCategoryButton" runat="server" Text="Add Subcategory" Width="102px" OnClick="AddSubCategoryButton_Click" />
                            </td>
                        </tr>
                        <tr>
                           <td>
                             <asp:Button ID="DeleteSubCategoryButton" runat="server" Text="Delete Subcategory" OnClick="DeleteSubCategoryButton_Click" />
                            </td>
                        </tr>
                        </table>
                        </td>
                        <td class="auto-style3">
                            <table>
                                <tr>
                                    <td class="auto-style4">
                                        <p style="font-weight: bold; font-size: large; ">SubCategories</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="auto-style4">
                                        <asp:ListBox ID="SubCategoryListBox" runat="server" Width="151px" AutoPostBack="True"></asp:ListBox>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <tr>
                            <td>
                                <table>
                                    ...
                                    <tr><td>
                                        <a href="Template_TrackletLabeling.aspx">See template description for information</a>
                                    </td></tr>
                                 </table>
                            </td>
                            <td>
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:TextBox ID="TargetFrameRate" runat="server" Width="206px">30</asp:TextBox>
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:TextBox ID="ChunkDuration" runat="server" Width="206px">60</asp:TextBox>
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:TextBox ID="ChunkOverlap" runat="server" Width="206px">0</asp:TextBox>
                   ...
                   <asp:Panel id="PricePanel" runat="server" Visible="False">   
                      ...
                      <tr>
                          ...
                          <td>
                              ...
                              <asp:TextBox ID="AmazonTaskTitleTextBox" runat="server" Width="336px">Label the actions of a tracklet in a video</asp:TextBox>
                      ...
                      <tr>
                          ...
                          <td>
                              <asp:TextBox ID="AmazonTaskDescriptionTextBox" runat="server" Width="336px">Quickly earn money by labeling the objects' actions in Video!  </asp:TextBox>
                          </td>
                          <td>
                      ...
                      <tr>
                          ...
                          <td>
                              <asp:TextBox ID="AmazonTaskKeywordsTextBox" runat="server" Width="336px">video, action annotation</asp:TextBox>
                          </td>
                          <td>
