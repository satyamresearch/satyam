<%@ Page Title="" Language="C#" MasterPageFile="~/JobTemplate.master" AutoEventWireup="true" CodeBehind="TemplateInfo_SingleObjectLabelingMTurk.aspx.cs" Inherits="SatyamPortal.TemplateInfo_SingleObjectLabelingMTurk" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table>
                        <tr>
                            <td>
                                 <h3>Template : Single Object Labeling Using Amazon Mechanical Turk</h3> 
                             </td>
                    ...
                    <h3>Demo Example : (<a href="http://satyamresearchtaskpages.azurewebsites.net/SingleObjectLabelingMTurkDemoPage.aspx" target="_blank">click here </a>(opens in a new tab)</h3>
