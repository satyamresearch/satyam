...
{
    public partial class Template_OpenEndedQuestionsImage : System.Web.UI.Page
    {
        ...
        protected void OpenEndedQuestion_JobSubmitButton_Click(object sender, EventArgs e)
        {
            ...
            if (Hidden_MechanicalTurk.Value == "true")
            {
                job.JobTemplateType = TaskConstants.OpenEndedQuestion_Image_MTurk;
                job.TasksPerJob = TaskConstants.SINGLE_OBJECT_LABLING_MTURK_MAX_IMAGES_PER_TASK;
            }
            else
            {
                job.JobTemplateType = TaskConstants.OpenEndedQuestion_Image;
