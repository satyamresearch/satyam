<%@ Page Language="C#" MasterPageFile="~/JobTemplate.master" AutoEventWireup="true" CodeBehind="Template_CamPoseEstimation.aspx.cs" Inherits="SatyamPortal.Template_CamPoseEstimation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id ="Template_OpenEndedQuestionsImage">        
                    <table>
                        <tr>
                            <td>
                                 <h3>Template : Camera Pose Estimation</h3> 
                             </td>
                            <td class="auto-style1" style="width: 263px">
                                <asp:Panel id="TemplateInfo" runat="server" Visible="True">
                                 <a href="TemplateInfo_CamPoseEstimation.aspx">Learn About this Template</a>
                                </asp:Panel>
                                <asp:Panel id="TemplateInfoMturk" runat="server" Visible="False">
                                 <a href="TemplateInfo_CamPoseEstimation_MTurk.aspx">Learn About this Template</a>
                                </asp:Panel>
                             </td>
                  ...
                  <asp:Panel id="PricePanel" runat="server" Visible="False">   
                      ...
                      <tr>
                          ...
                          <td>
                              ...
                              <asp:TextBox ID="AmazonTaskTitleTextBox" runat="server" Width="336px">Camera Pose Annotation</asp:TextBox>
                      ...
                      <tr>
                          ...
                          <td>
                              <asp:TextBox ID="AmazonTaskDescriptionTextBox" runat="server" Width="336px">Quickly earn money by annotating an image!</asp:TextBox>
                          </td>
                          <td>
                      ...
                      <tr>
                          ...
                          <td>
                              <asp:TextBox ID="AmazonTaskKeywordsTextBox" runat="server" Width="336px">Pictures, Images</asp:TextBox>
                          </td>
                          <td>
