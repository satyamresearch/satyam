<%@ Page Title="" Language="C#" MasterPageFile="~/JobTemplate.master" AutoEventWireup="true" CodeBehind="Template_ObjectCountingInVideo.aspx.cs" Inherits="SatyamPortal.Template_ObjectCountingInVideo" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id ="Template_SingleObjectCountingInVideo">        
                    <table>
                        <tr>
                            <td>
                            ...
                            <td class="auto-style1" style="width: 263px">
                                <asp:Panel id="TemplateInfo" runat="server" Visible="True">
                                 <a href="TemplateInfo_ObjectCountingInVideo.aspx">Learn About this Template</a>
                                </asp:Panel>
                                <asp:Panel id="TemplateInfoMturk" runat="server" Visible="False">
                                 <a href="TemplateInfo_ObjectCountingInVideoMTurk.aspx">Learn About this Template</a>
                                </asp:Panel>
                             </td>
...
&nbsp;
        ...
        <div id="ErrorField"> 
            <asp:Label ID="Template_ErrorMessageLabel" runat="server" Text=""></asp:Label>
                   ...
                   <h3>Image Location Information</h3> (Note : All the videos in this location will be launched for labeling automatically. The results file will be stored in the same location.)
                   <table>
                   <tr><td>
                   <table>
                       <tr>
